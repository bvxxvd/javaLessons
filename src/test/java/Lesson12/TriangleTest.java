...
public class TriangleTest {
    ...
    void throwAnExceptionNotTriangle() {
        Exception exception = assertThrows(ArithmeticException.class, () -> triangle.squareTriangle(1, 2, 4));
    ...
    void throwAnExceptionNotCurrentArguments() {
        ...
        Exception exception = assertThrows(ArithmeticException.class, () -> triangle.squareTriangle(0, -2, 1));
